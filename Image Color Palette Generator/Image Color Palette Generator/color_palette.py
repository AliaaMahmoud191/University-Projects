...
class App:
    ...
    def __init__(self, tkObject):
        ...
        self.img_text_label = tk.Label(tkObject, fg = self.fg, font="Calibri 23 bold", bg=self.bg, padx = 50, pady=50, text="Color Palette Generator")
        ...
        self.palette_title = tk.Label(tkObject, fg=self.fg, font=self.font, bg=self.bg, text="Colour Palette:" if self.pressed else None)
        ...
        self.palette_image = tk.Label(tkObject, fg=self.fg, font=self.font, bg=self.bg, image=placeholder_tk_image if self.pressed else None, width=400, height=50)
